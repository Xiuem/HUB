...
local Tabs = {
	...
	Status = Window:AddTab({ Title = "Status", Icon = "bone" }),
...
local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Turn On v4", Default = false })
    ...
    spawn(function()
       ...
       local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Turn On v3", Default = false })
...
local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Remove Effect ", Default = false })
...
local ToggleWhite = Tabs.Setting:AddToggle("MyToggle", {Title = "White Screen", Default = false })
    ...
    local Toggle = Tabs.Setting:AddToggle("MyToggle", {Title = "Remove Notify", Default = false })
