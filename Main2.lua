...
local Tabs = {
    ...
    Fluent = Window:AddTab({ Title = "Fluent", Icon = "axe" }),
}
...
if id == 2753915549 then First_Sea = true; elseif id == 4442272183 then Second_Sea = true; elseif id == 7449423635 then Third_Sea = true; else game.Players.LocalPlayer:Kick("Check script here : Xemo Community") end;
-- anti
function AntiBan()
...
L_92_.Image = "rbxassetid://17444747811"
...
local Toggle = Tabs.Settings:AddToggle("ToggleBringMob", {Title = "Bring Mob", Default = true })
    Toggle:OnChanged(function(Value)
        _G.BringMob = Value
    end)
