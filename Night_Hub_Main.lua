...
ImageButton.Size = UDim2.new(0, 40, 0, 50)
...
local Window = Fluent:CreateWindow({
    Title = "Xemo Hub ",
    SubTitle = "Chi Co Ta Moi Co The Bo Con",
    TabWidth = 160,
...
Fluent:Notify({
    Title = "Xemo Hub",
    Content = "[Xemo Hub] Welcome Again To Script",
...
local Info = Tabs.About:AddSection("Information")
...
Tabs.About:AddParagraph({
    Title = "Anti Banana Hub",
    Content = "Apple W-azure Hub On Top"
})
...
local DC = Tabs.About:AddSection("Upgrated and Discord")
...
Tabs.About:AddButton({
    ...
    Description = "Click the button to join Discord",
    Callback = function()
