...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Elite", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Fram Observation", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Observation Haki V2", Default = false })
