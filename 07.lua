...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm level", Default = false })
	...
	Tabs.Main:AddSection("Auto New World")
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Sea 3", Default = false })
    ...
    Tabs.Main:AddSection("Auto Fram Mastery")
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Elite", Default = false })
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Kill Rip Indra", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Kill Dough King", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Fram Chest[Tween]", Default = false })
...
spawn(function()
 ...
 local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto kill DarkBeard", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto Fram Observation", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto Observation V2", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto Random Fruit", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Auto Store Fruit", Default = false })
  ...
  "Leopard-Leopard"
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Buy Fruit", Default = false })
  ...
  pcall(function()
   ...
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Tween Fruit[Tween]", Default = false })
