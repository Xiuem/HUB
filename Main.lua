...
Tabs.Main:AddParagraph({
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Fram Bone", Default = false })
    ...
    spawn(function()
        ...
        local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Katakuri[Error Bring mobs]", Default = false })
    ...
    while wait() do
      ...
      game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-2077, 252, -12373)
            ...
            game:GetService'VirtualUser':Button1Down(Vector2.new(0,1,0,1))
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
                                topos(game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(0,20,0))
                            else
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                                    topos(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(0,40,0))
                                end
                            end
                        end
                    end
    ...
    Tabs.Main:AddParagraph({
        Title = "",
        Content = "Mastery Fram"
    })
    
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Fram Mastery Fruit", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Fram Mastery Gun", Default = false })
...
spawn(function()
    ...
    Tabs.Main:AddParagraph({
        Title = "",
        Content = "Unlock World"
    })
    
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Second Sea", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Third Sea", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto kill Elite", Default = false })
 ...
 local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Factory", Default = false })
    ...
    StopTween(_G.AutoFactory)
        ...
        local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Pirate Raid[Beta]", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm Exp Observation", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Quest Observation V2", Default = false })
	...
	local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Chest [TP]Need Jumps", Default = false })
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
   ...
   _G.AutoBuyLegendarySword = Value
    ...
    local Toggle = Tabs.Sh:AddToggle("MyToggle", {Title = "Random Bone", Default = false })
...
local BoneCheck = Tabs.St:AddParagraph({
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Tween Mystic Island", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Tween Gear", Default = false })
   ...
   local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Quest Evo Race V2[Beta]", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken Superhuman", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken DeathStep", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken Sharkman Karate", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken Electric Claw", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken Dragon Talon", Default = false })
    ...
    local Toggle = Tabs.Ms:AddToggle("MyToggle", {Title = "Taken GodHuman", Default = false })
...
"Tiki Outpost"},
    ...
    local Toggle = Tabs.Lc:AddToggle("MyToggle", {Title = "Travel[Tween]", Default = false })
