...
Fluent:Notify({
    Title = "Night Hub",
    Content = "[Night Hub] Welcome Again To Script",
...
Tabs.I:AddParagraph({
    Title = "Owner Script",
    Content = "Owner Script : NightX.\nMy Brothers : ! DestroyX, T...!"
})
...
Tabs.I:AddButton({
    ...
    Description = "Click the button to join Discord 'Night Hub #1000 Member ' ",
    Callback = function()
